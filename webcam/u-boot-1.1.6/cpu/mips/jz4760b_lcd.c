...
#if defined(CONFIG_JZ4760B) || defined(CONFIG_JZ4760)
#if defined(CONFIG_LCD) && !defined(CONFIG_SLCD)
#include <asm/jz4760b.h>
#include "jz4760b_lcd.h"
...
#elif defined(CONFIG_JZ4760_F_LCD)
        .panel = {
                .cfg = LCD_CFG_LCDPIN_LCD | LCD_CFG_RECOVER | /* Underrun recover */
                LCD_CFG_NEWDES | /* 8words descriptor */
                LCD_CFG_MODE_GENERIC_TFT | /* General TFT panel */
                ...
                LCD_CFG_HSP |   /* Hsync polarity: active low */
                LiCD_CFG_VSP,    /* Vsync polarity: leading edge is falling edge */
                .slcd_cfg = 0,
                .ctrl = LCD_CTRL_OFUM | LCD_CTRL_BST_16,        /* 16words burst, enable out FIFO underrun irq */
...
#elif defined(CONFIG_JZ4760_SLCD_KGM701A3_TFT_SPFD5420A)
	400, 240, LCD_BPP,
//#elif defined(CONFIG_JZ4760_LCD)
//	800, 480, LCD_BPP,
#else
#error "Select LCD panel first!!!"
#endif
...
static int  jz_lcd_hw_init(vidinfo_t *vid)
{
	...
	u_long clock = __cpm_get_pixclk();

//	__cpm_select_pixclk_lcd();
	REG_CPM_CPCCR |= CPM_CPCCR_CE ; /* update divide */

#if DEBUG
	clock = __cpm_get_pixclk();
	printf("LCDC: PixCLOCK2 ::%d\n", clock);
