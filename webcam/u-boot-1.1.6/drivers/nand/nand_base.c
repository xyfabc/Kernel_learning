...
#elif defined(CONFIG_JZ4750) || defined(CONFIG_JZ4750D) || defined(CONFIG_JZ4750L) || defined(CONFIG_JZ4760) || defined(CONFIG_JZ4770) || defined(CONFIG_JZ4810) || defined(CONFIG_JZ4780) || defined(CONFIG_JZ4775)
	...
	u_char *oob_buf,  struct nand_oobinfo *oobsel, int cached)
{
	...
	case NAND_ECC_HW13_512:
		...
		for (; eccsteps; eccsteps--) {
			...
			buf_calc->oob = oob_buf + (CFG_NAND_ECC_POS / this->eccsteps) * (this->eccsteps - eccsteps);
...
#define NAND_LOW_CHIP_SIZE	2048
	...
	mtd->oobsize = type->oobsize > 128 ? 128 : type->oobsize;
