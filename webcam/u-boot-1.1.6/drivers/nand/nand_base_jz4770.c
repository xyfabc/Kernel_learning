	...
	u_char *oob_buf,  struct nand_oobinfo *oobsel, int cached)
{
	...
	case NAND_ECC_HW20_512:
	case NAND_ECC_HW26_512:
	case NAND_ECC_HW33_512:
			     ...
			     struct nand_oobinfo *oobsel)
{
	...
	while (read < len) {
		...
		} else if ( (NAND_ECC_HW7_512 == eccmode) 
			   || (NAND_ECC_HW13_512 == eccmode)
			   || (NAND_ECC_HW20_512 == eccmode)
			   || (NAND_ECC_HW26_512 == eccmode)
			   || (NAND_ECC_HW33_512 == eccmode)
			   || (NAND_ECC_HW39_512 == eccmode) ) {
