...
struct jz_fb_info {
	...
	/* DMA descriptors */
#if defined(CONFIG_JZ4730) || defined(CONFIG_JZ4740) || defined(CONFIG_JZ4750) || defined(CONFIG_JZ4755) || defined(CONFIG_JZ4760) || defined(CONFIG_JZ4760B) || defined(CONFIG_JZ4770)
...
#else	
	struct	jz_fb_dma_descriptor *	dma_desc0;
	struct	jz_fb_dma_descriptor *	dma_desc1;
	struct	jz_fb_dma_descriptor *	dma_desc_dummy;
	struct	jz_fb_dma_descriptor *	dma_desc_palette;
#endif
