...
/*
 * Auto Update when power up
 */
#undef CONFIG_AUTOUPDATE
#ifdef CONFIG_AUTOUPDATE
#define IMAGE_NAME		"uimage.oob"
#define IMAGE_OFFSET		"400000"	/* offset of nand which the image burned to  */
#define YAFFS_NAME		"root26.yaffs2"
#define YAFFS_OFFSET		"800000"
#endif
