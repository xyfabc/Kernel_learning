...
#define CONFIG_JZ4775		1  /* Jz4775 SoC */
#define CONFIG_DDRC		1  /* use ddr controller */

//#define CONFIG_DISABLE_CONSOLE_YJT

//lcd config
#define CONFIG_LCD
#ifdef  CONFIG_LCD
#define LCD_BPP         5       
//#define CONFIG_LCD_TOPPOLY_TD043MGEB1
//#define CONFIG_SLCD_KGM_SPFD5420A
//#define CONFIG_SLCD_BG28021
#define CONFIG_JZ_LCD_BL35026V0
#define CONFIG_LCD_LOGO
#define CFG_LCD_LOGOONLY_NOINFO

#if defined(CONFIG_JZ_LCD_BL35026V0)
#define CONFIG_GPIO_BACKLIGHT_PIN  (32 * 4 + 1)       // PE1, yjt, 20130823
#elif defined(CONFIG_SLCD_BG28021)
#define CONFIG_GPIO_BACKLIGHT_PIN  (32 * 1 + 30)       // PB30, yjt, 20130821
#else
	#error "define lcd bl pin first, in include/configs/mensa.h"
#endif
#endif
...
#include "asm/jz_mem_nand_configs/DDR3_H5TQ4G63BFR.h"	// mod by xyf at 20180813  for 2G-->4G
//#include "asm/jz_mem_nand_configs/DDR3_H5TQ1G63EFR.h"
#else
...
#define CFG_CPU_SPEED		(936 * 1000000)	/* CPU clock: 800M */
#define CFG_MPLL_SPEED		(936 * 1000000)
/* #define CFG_MPLL_SPEED		(720 * 1000000) */
...
#ifdef CONFIG_DISABLE_CONSOLE_YJT
#define CONFIG_BOOTDELAY	0	// yjt, 20130813, 1 -> 0
#else
...
#else
#define LINUX_CMDLINE0 \
	"mem=256M console=ttyS0,57600n8 ip=off root=/dev/mmcblk0p1 rw"		// del, yjt, 20130717
#endif
#ifdef CONFIG_DISABLE_CONSOLE_YJT
#define LINUX_CMDLINE1 \
	"mem=255M  mem=256M@0x30000000 console=null ip=off root=/dev/mmcblk0p1 ro quiet"		// yjt, 20130813, disable console
//	"mem=128M console=ttyS3,57600n8 ip=off root=/dev/mmcblk0p1 rw"		// del, yjt, 20130813,
//	"mem=256M console=ttyS3,57600n8 ip=off root=/dev/mmcblk0p1 rw"		// del, yjt, 20130717
//	"mem=256M console=ttyS3,57600n8 ip=off root=/dev/ram0 rw"
#else
#define LINUX_CMDLINE1 \
	"mem=256M@0x0 mem=256M@0x30000000  console=ttyS3,57600n8 ip=off root=/dev/mmcblk0p1 ro"	
//	"mem=128M console=null ip=off root=/dev/mmcblk0p1 rw quiet"	
#endif
...
#define CONFIG_BOOTCOMMAND	"msc read 0x80600000 0x400000 0x400000;bootm"
#else
#define CONFIG_BOOTARGS		LINUX_CMDLINE0
#define CONFIG_BOOTCOMMAND	"msc read 0x80600000 0x400000 0x300000;bootm" //"tftpboot;bootm"
#endif

#define CFG_AUTOLOAD		"n"		/* No autoload */

#define CONFIG_SERVERIP		192.168.132.104		// yjt, 20130509
#define CONFIG_IPADDR		192.168.132.55		// yjt, 20130509
#define CONFIG_NET_MULTI
#define CONFIG_ETHADDR		00:2a:c6:2c:bd:f9    /* Ethernet address */ // yjt, 20130509
...
#define	CFG_PROMPT		"B11# "	/* Monitor Command Prompt    */ // yjt, 20130509
...
#define CFG_NAND_BCH_BIT	8	/* Specify the hardware BCH algorithm for 4775 (4|8) */
...
#define CFG_NAND_USE_PN		0	/* Use PN in jz4775 for TLC NAND */
...
#define CFG_MSC_U_BOOT_SIZE	(640 << 10)	/* Size of RAM U-Boot image	*/
 ...
 * GPIO
 */
#define GPIO_LCD_PWM   		(32*4 + 2) 	// pe2/pwm2, yjt, 20130509, change

// #define ACT8600_I2C                I2C2_BASE		// yjt, 20130509, del
#define GPIO_SDA        (32 * 4 + 0)    /* GPE30 */
#define GPIO_SCL        (32 * 4 + 3)    /* GPE31 */
...
#define PTN_MISC_SIZE               (1* 0x100000)
#define PTN_KERNEL_SIZE             (4* 0x100000)
#define PTN_RECOVERY_SIZE           (0* 0x100000)
#define PTN_SYSTEM_SIZE             (512* 0x100000)
#define PTN_USERDATA_SIZE           (128* 0x100000)
#define PTN_CACHE_SIZE              (128* 0x100000)	/* optional */
/*======== Partition offset ============ */
...
/*======== Partition size ============ */
#define PTN_UBOOT_SIZE				(4 * 0x100000)	
#define PTN_KERNEL_SIZE             (4 * 0x100000)
#define PTN_SYSTEM_SIZE             (512 * 0x100000)
#define PTN_USERDATA_SIZE           (128 * 0x100000)
#define PTN_CACHE_SIZE              (128 * 0x100000)	/* optional */
/*======== Partition offset ============ */
#define PTN_UBOOT_OFFSET			(0)		/* 0 is MBR offset,MBR in combination with UBOOT */
#define PTN_KERNEL_OFFSET           (PTN_UBOOT_OFFSET + PTN_UBOOT_SIZE)
#define PTN_SYSTEM_OFFSET         	(PTN_KERNEL_OFFSET + PTN_KERNEL_SIZE)
#define PTN_USERDATA_OFFSET			(PTN_SYSTEM_OFFSET + PTN_SYSTEM_SIZE)  
#define PTN_CACHE_OFFSET			(PTN_USERDATA_OFFSET + PTN_USERDATA_SIZE)  /* optional */
