...
#define LINUX_CMDLINE0 \
	"mem=255M@0x0 mem=256M@0x30000000 console=ttyS2,57600n8 ubi.mtd=2 root=ubi0:ubifs rootfstype=ubifs rw"

#define LINUX_CMDLINE1 \
	"mem=192M console=ttyS2,57600n8 ip=192.168.10.125 rw rdinit=/linuxrc"

#define LINUX_CMDLINE2 \
	"mem=192M console=ttyS2,57600n8 ip=off root=/dev/ram0 rw rdinit=/linuxrc"

#define LINUX_CMDLINE3 \
	"mem=256M console=ttyS2,57600n8 ip=off root=/dev/mmcblk0p1 rw"

#define LINUX_CMDLINE4 \
	"mem=192M console=ttyS2,57600n8 ip=192.168.1.125 nfsroot=192.168.1.171:/root/ingenic/nfsroot rw noinitrd"

#define LINUX_CMDLINE5 \
	"mem=192M console=ttyS2,57600n8 ip=192.168.10.125 nfsroot=192.168.10.115:/root/ingenic/nfsroot rw noinitrd"
#define LINUX_CMDLINE6 \
	"mem=255M@0x0 mem=256@0x30000000 console=ttyS2,57600n8 ip=off rootfstype=yaffs2 root=/dev/mtdblock2 rw"
...
#define	CFG_PROMPT		"PISCES # "	/* Monitor Command Prompt    */
...
#define GPIO_REVY_KEY_DEFAULT           (32*4+19)   //sw8 pd19

#define UBOOT_SEL_REVY_KEY1             GPIO_REVY_KEY_DEFAULT
#define UBOOT_SEL_REVY_KEY2             GPIO_REVY_KEY_DEFAULT
#define UBOOT_SEL_REVY_KEY3             GPIO_REVY_KEY_DEFAULT
