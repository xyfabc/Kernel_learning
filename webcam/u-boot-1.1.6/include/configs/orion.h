...
#include "asm/jz_mem_nand_configs/MCP_H9DA4GHJJAMCR-4EM.h"
...
#define CFG_CPU_SPEED		(1008 * 1000000)	/* CPU clock: 1008M */
#define CFG_MPLL_SPEED		(792 * 1000000)
#define CFG_DDR_DIV             6		/* for ddr div */
...
#else
#define LINUX_CMDLINE0 \
	"mem=256M console=ttyS0,57600n8 ip=off root=/dev/mmcblk0p1 rw"
#endif
#define LINUX_CMDLINE1 \
	"mem=256M mem=256M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw"
...
#define CONFIG_BOOTCOMMAND	"msc read 0x80600000 0x400000 0x600000;bootm"
#else
...
#define CFG_MSC_U_BOOT_SIZE	(320 << 10)	/* Size of RAM U-Boot image	*/
