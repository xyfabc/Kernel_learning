...
#define DDR_tFAW 38		/* Four bank activate period, ns */
...
#define DDR_tXARDS (6 - DDR_tAL)/* DDR2 only: Exit active power down to read command (slow exit/low power mode), tCK */
