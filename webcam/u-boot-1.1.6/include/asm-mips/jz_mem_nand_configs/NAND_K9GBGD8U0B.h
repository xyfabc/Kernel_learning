...
#define CFG_NAND_TOGGLE		1		/* Toggle I/O NAND */
#define CFG_NAND_BCH_BIT        40		/* Specify the hardware BCH algorithm for nand (4|8) */
#define CFG_NAND_BW8		1		/* Data bus width: 0-16bit, 1-8bit */
#define CFG_NAND_PAGE_SIZE      8192
#define CFG_NAND_OOB_SIZE	1024		/* Size of OOB space per page (e.g. 64 128 etc.) */
