...
#define DDR_tDQSCK    	1 * ps / 1000	/* LPDDR only: DQS output access from ck_t/ck_c, 2.5ns */
#define DDR_tDQSCKMAX 	1 * ps / 1000	/* LPDDR only: MAX DQS output access from ck_t/ck_c, 5.5ns */
#else
#define DDR_tDQSCK    	3	/* LPDDR only: DQS output access from ck_t/ck_c, 2.5ns */
#define DDR_tDQSCKMAX 	6	/* LPDDR only: MAX DQS output access from ck_t/ck_c, 5.5ns */
#endif

#define DDR_BL	 	8	/* LPDDR2 Burst length: 3 - 8 burst, 2 - 4 burst , 4 - 16 burst*/
#define DDR_tAL  	0	/* Additive Latency, tCK*/
#define DDR_tRL  	5	/* LPDDR2: Read Latency  - 3 4 5 6 7 8 , tck*/
