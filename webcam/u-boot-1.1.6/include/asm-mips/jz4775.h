 ...
 */
#define UART_MSR_CCTS	(1 << 0)	/* 0: no change on CTS_ pin since last read of UART_MSR */
...
#define SSI_RCNT(n)		(SSI##n##_BASE + 0x01C)
...
#define LCD_BGC0	(LCD_BASE + 0x10C) /* LCD Background Color Register */
#define LCD_BGC1	(LCD_BASE + 0x24C) /* LCD Background Color Register */
...
#define REG_LCD_BGC0	REG32(LCD_BGC0)
#define REG_LCD_BGC1	REG32(LCD_BGC1)
